...
import { DashboardProvider } from "@/components/DashboardContext"; // ĐÃ THÊM: Import Provider
import { createClient } from "@/utils/supabase/server";
import { cookies } from "next/headers";
import Link from "next/link";
import { notFound, redirect } from "next/navigation";
import { Suspense } from "react"; // ĐÃ THÊM: Lớp bảo vệ chống lỗi tải dữ liệu
...
export default async function MemberDetailPage({ params }: PageProps) {
  ...
  return (
    // ĐÃ THÊM: Bao bọc toàn bộ giao diện bằng Suspense và DashboardProvider
    <Suspense fallback={<div className="p-8 text-center text-stone-500">Đang tải dữ liệu...</div>}>
      <DashboardProvider>
